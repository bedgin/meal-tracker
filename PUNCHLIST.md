...
- [x] On the Today page, change the "See Details" button to read "Today's Meals" and move it up under the Protein box.
- [x] On the Today screen, change the library button to a text link and add it to the right side of the header, opposite "Sign out".
- [x] On the Details screen, remove the "Delete" button from the bottom row of each meal.
- [x] On the Details screen, where cal and protein are listed for each meal, protein should be formatted the same as cal.
